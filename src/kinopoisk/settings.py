...
SECRET_KEY = 'oq5tx2cqe)h2x(9o-004a&0p!$j8vz$ua&*oz$@4z!x1&_c_$@'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get("DB_NAME", 'kinopoisk'),
...
AUTH_USER_MODEL = 'main.KinopoiskUser'

LOGIN_URL = 'authPage'

URL = 'http://127.0.0.1:8000'

EMAIL_FROM_EMAIL = os.environ.get("EMAIL_FROM_EMAIL", "amir.g4inullin@yandex.ru")
EMAIL_FROM_NAME = "FILMAX"
DEFAULT_FROM_EMAIL = EMAIL_FROM_EMAIL

EMAIL_HOST_PASSWORD = os.environ.get("EMAIL_HOST_PASSWORD", "zuucumvhkibezipt")
